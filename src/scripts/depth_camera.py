...
def main(args):
	...
	image_depth_sub=rospy.Subscriber("/camera/depth/image_rect_raw", Image,depth_image_callback)
	image_rgb_sub=rospy.Subscriber("/camera/color/image_raw", Image,rgb_image_callback)
	try:
		rospy.spin()
